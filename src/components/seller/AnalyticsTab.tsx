                ...
                <div className="grid gap-4 md:grid-cols-3">
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium">{t('total_listings')}</CardTitle>
                     ...
                     <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium">{t('message_count')}</CardTitle>
                            <MessageSquareIcon className="h-4 w-4 text-muted-foreground" />
                        </CardHeader>
                        <CardContent>
                            <div className="text-2xl font-bold">12</div>
                            <p className="text-xs text-muted-foreground">+4 new messages</p>
                        </CardContent>
                    </Card>
                </div>
                <div className="mt-8 text-center bg-muted p-6 rounded-lg">
                    <p className="font-medium">{t('analytics_coming_soon')}</p>
                </div>
            </CardContent>
        </Card>
    )
